  ...
  return (
    <>
      {connected ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="pt-2">
            ...
            <div className="-m-2 flex flex-wrap items-center justify-between">
              ...
              <div className="relative m-2 mr-4">
                ...
                <div className="absolute inset-y-0 left-0 flex pl-3 pr-2">
                  <svg
                    ...
                    className={
                      (slugTag ? "text-primary-500 " : "text-skin-third ") +
                      "m-auto h-5 w-5"
                    }
                    viewBox="0 0 20 20"
                    fill="currentColor"
              ...
              <div className="m-2 ml-auto flex items-center space-x-4">
                ...
                <button
                  onClick={onClose}
                  className="rounded-full px-4 py-2 font-semibold text-skin-pirmary bg-current"
                >
                  Close
                </button>
                <button
        ...
        <div className="border-b bg-current px-8 py-4 text-center text-skin-secondary">
