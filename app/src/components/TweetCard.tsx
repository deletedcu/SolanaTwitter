      ...
      {isEditing ? (
        ...
        <div className="px-8 pt-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="inline font-semibold text-skin-primary" title={tweet.user_display}>
              <Link href={userRoute}>
                <a className="hover:underline">{tweet.user_display}</a>
              </Link>
            </h3>
            <span className="text-skin-secondary">•</span>
            <time className="text-sm text-skin-secondary" title={tweet.created_at}>
          ...
          <div className="ml-12 border-b border-current pb-4">
            <div className="flex flex-col py-4 px-8 border border-current rounded-lg bg-skin-secondary">
              <p className="whitespace-pre-wrap text-skin-secondary">{tweet.content}</p>
              <div className="flex">
                  ...
                  {isOwner && (
                    ...
                    >
                      <svg
                        ...
                        aria-hidden="true"
                        role="img"
                        className="h-6 w-6 p-1 text-skin-third hover:text-primary-600 iconify iconify--heroicons-outline"
                        width="1em"
                        height="1em"
                        preserveAspectRatio="xMidYMid meet"
                        viewBox="0 0 24 24"
